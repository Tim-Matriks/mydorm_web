...
<head>
    ...
    <title>Edit Log Keluar Masuk</title>
    <!-- Bootstrap CSS -->
    ...
    <section id="content" class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light d-flex justify-content-between align-items-center mb-3">
            <div class="d-flex align-items-center">
                ...
                <h1 class="h4 mb-0">Edit Log Keluar-Masuk</h1>
            </div>
            <div class="d-flex align-items-center">
                    ...
                    <div class="input-container mb-3">
                        ...
                        <div class="status-container mb-3">
                            ...
                            <div class="pilihan-status">
                                <input type="radio" id="status-diterima" name="status" value="diterima" class="form-check-input">
                                <label for="status-diterima" class="form-check-label">diterima</label><br>
                            </div>
                            <div class="pilihan-status">
                                <input type="radio" id="status-pending" name="status" value="pending" class="form-check-input">
                                <label for="status-pending" class="form-check-label">pending</label><br>
                            </div>
                            <div class="pilihan-status">
                                <input type="radio" id="status-ditolak" name="status" value="ditolak" class="form-check-input">
